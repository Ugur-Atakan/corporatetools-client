...
export type CTDocumentType = 'Active Filings Original Client Document' | 'Amendment' | 'Annual Report' | 'Bad Scan' | 'BOI Amendment' | 'BOI Initial' | 'Business Plan' | 'Certified Mail' | 'Certified Mail service of Process' | 'Client Upload' | 'Corporate Bylaws' | 'Corporate maintenance notice' | 'Credit Card Quote' | 'Delivered Service of Process' | 'EIN Letter' | 'EIN - SS4 Form' | 'Filing Document' | 'Form A Company' | 'Formation Document' | 'Hand delivered service of process' | 'High Priority' | 'Historical' | 'Incorporate Fast Original Client Document' | 'Informational document' | 'Initial Filing' | 'Initial Resolution' | 'Initial Vehicle Documentation' | 'Law on Call ToS Agreement' | 'NWRA Free Documents' | 'Ongoing Filing' | 'Operating Agreement' | 'Original CFS Document' | 'Original Filing' | 'Regular Mail' | 'Rejection Notice' | 'State Compliance' | 'State Notice' | 'Vehicle Mail' | 'Vehicle Renewal Notice' | 'VO Office Lease';
...
export type CTServiceStatus = 'active' | 'cancelled' | 'awaiting-client-input' | 'cancel-requested';
